...
response_time = Histogram("agent_response_seconds", "Response time in seconds")


# Cache effectiveness metrics
cache_hits = Counter("agent_cache_hits_total", "Total number of cache hits")

cache_misses = Counter("agent_cache_misses_total", "Total number of cache misses")
...
agent = AnthropicAgent(
    api_key=api_key, system_prompt=None, redis_host=redis_host, redis_port=redis_port
)
